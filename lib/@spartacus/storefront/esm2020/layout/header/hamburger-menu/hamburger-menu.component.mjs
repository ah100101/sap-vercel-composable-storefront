...
HamburgerMenuComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: HamburgerMenuComponent, deps: [{ token: i1.HamburgerMenuService }], target: i0.ɵɵFactoryTarget.Component });
