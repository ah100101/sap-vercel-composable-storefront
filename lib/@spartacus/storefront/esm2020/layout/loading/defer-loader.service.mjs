...
DeferLoaderService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: DeferLoaderService, deps: [{ token: PLATFORM_ID }, { token: i1.LayoutConfig }, { token: i2.IntersectionService }], target: i0.ɵɵFactoryTarget.Injectable });
