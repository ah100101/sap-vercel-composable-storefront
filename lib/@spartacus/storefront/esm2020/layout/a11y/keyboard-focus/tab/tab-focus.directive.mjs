...
TabFocusDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: TabFocusDirective, deps: [{ token: i0.ElementRef }, { token: i1.TabFocusService }], target: i0.ɵɵFactoryTarget.Directive });
