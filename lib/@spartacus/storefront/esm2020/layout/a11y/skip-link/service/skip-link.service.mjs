...
SkipLinkService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: SkipLinkService, deps: [{ token: i1.SkipLinkConfig }, { token: i2.KeyboardFocusService }], target: i0.ɵɵFactoryTarget.Injectable });
