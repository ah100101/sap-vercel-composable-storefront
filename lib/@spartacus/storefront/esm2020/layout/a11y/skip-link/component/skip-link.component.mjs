...
SkipLinkComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: SkipLinkComponent, deps: [{ token: i1.SkipLinkService }], target: i0.ɵɵFactoryTarget.Component });
