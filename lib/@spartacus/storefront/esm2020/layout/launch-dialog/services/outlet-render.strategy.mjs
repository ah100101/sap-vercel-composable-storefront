...
OutletRenderStrategy.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: OutletRenderStrategy, deps: [{ token: DOCUMENT }, { token: i0.RendererFactory2 }, { token: i1.OutletService }, { token: i0.ComponentFactoryResolver }, { token: i2.OutletRendererService }], target: i0.ɵɵFactoryTarget.Injectable });
