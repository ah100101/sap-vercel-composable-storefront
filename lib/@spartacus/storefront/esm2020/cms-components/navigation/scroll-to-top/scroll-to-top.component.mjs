...
ScrollToTopComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ScrollToTopComponent, deps: [{ token: i1.WindowRef }, { token: i2.CmsComponentData }, { token: i3.SelectFocusUtility }], target: i0.ɵɵFactoryTarget.Component });
