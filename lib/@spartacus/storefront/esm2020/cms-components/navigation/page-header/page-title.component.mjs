...
PageTitleComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: PageTitleComponent, deps: [{ token: i1.CmsComponentData }, { token: i2.PageMetaService }], target: i0.ɵɵFactoryTarget.Component });
