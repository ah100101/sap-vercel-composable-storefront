...
IconLoaderService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: IconLoaderService, deps: [{ token: i1.WindowRef }, { token: i2.IconConfig }, { token: i3.DomSanitizer }], target: i0.ɵɵFactoryTarget.Injectable });
