...
VideoComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: VideoComponent, deps: [{ token: i1.CmsComponentData }, { token: i2.MediaService }, { token: i3.SemanticPathService }, { token: i3.CmsService }, { token: i0.ChangeDetectorRef }], target: i0.ɵɵFactoryTarget.Component });
