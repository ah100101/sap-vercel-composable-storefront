...
PageSlotModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: PageSlotModule, deps: [{ token: i1.PageSlotService }], target: i0.ɵɵFactoryTarget.NgModule });
