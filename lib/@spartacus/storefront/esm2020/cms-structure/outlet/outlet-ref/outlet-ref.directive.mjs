...
OutletRefDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: OutletRefDirective, deps: [{ token: i0.TemplateRef }, { token: i1.OutletService }], target: i0.ɵɵFactoryTarget.Directive });
