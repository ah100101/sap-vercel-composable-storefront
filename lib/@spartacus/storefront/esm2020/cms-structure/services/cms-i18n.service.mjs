...
CmsI18nService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CmsI18nService, deps: [{ token: i1.CmsComponentsService }, { token: i2.TranslationService }, { token: i2.TranslationChunkService }], target: i0.ɵɵFactoryTarget.Injectable });
