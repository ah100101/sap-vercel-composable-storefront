...
SeoMetaService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: SeoMetaService, deps: [{ token: i1.Title }, { token: i1.Meta }, { token: i2.PageMetaService }, { token: i3.PageMetaLinkService }], target: i0.ɵɵFactoryTarget.Injectable });
