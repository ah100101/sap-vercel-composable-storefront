...
JsonLdDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: JsonLdDirective, deps: [{ token: i0.Renderer2 }, { token: i1.JsonLdScriptFactory }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
