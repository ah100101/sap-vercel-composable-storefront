...
RoutingModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: RoutingModule, imports: [CoreRoutingModule.forRoot(), CmsRouteModule] });
