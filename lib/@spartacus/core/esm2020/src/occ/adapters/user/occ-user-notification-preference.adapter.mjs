...
OccUserNotificationPreferenceAdapter.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: OccUserNotificationPreferenceAdapter, deps: [{ token: i1.HttpClient }, { token: i2.ConverterService }, { token: i3.OccEndpointsService }], target: i0.ɵɵFactoryTarget.Injectable });
