...
ConsentService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ConsentService, deps: [{ token: i1.AnonymousConsentsService }, { token: i2.UserConsentService }], target: i0.ɵɵFactoryTarget.Injectable });
