...
UserNotificationPreferenceConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserNotificationPreferenceConnector, deps: [{ token: i1.UserNotificationPreferenceAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
