...
UserInterestsConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserInterestsConnector, deps: [{ token: i1.UserInterestsAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
