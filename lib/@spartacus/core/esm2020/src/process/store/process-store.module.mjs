...
ProcessStoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: ProcessStoreModule, imports: [StateModule, i1.StoreFeatureModule] });
ProcessStoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ProcessStoreModule, providers: [reducerProvider], imports: [StateModule, StoreModule.forFeature(PROCESS_FEATURE, reducerToken)] });
