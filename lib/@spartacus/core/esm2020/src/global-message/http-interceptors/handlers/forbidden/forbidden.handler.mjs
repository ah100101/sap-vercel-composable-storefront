...
ForbiddenHandler.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ForbiddenHandler, deps: [{ token: i1.GlobalMessageService }, { token: i2.AuthService }, { token: i3.OccEndpointsService }], target: i0.ɵɵFactoryTarget.Injectable });
