...
GlobalMessageStoreModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: GlobalMessageStoreModule, imports: [StateModule, i1.StoreFeatureModule] });
GlobalMessageStoreModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: GlobalMessageStoreModule, providers: [reducerProvider], imports: [StateModule,
