...
ConfigurationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ConfigurationService, deps: [{ token: RootConfig }, { token: DefaultConfig }, { token: i1.UnifiedInjector }, { token: i2.Config }], target: i0.ɵɵFactoryTarget.Injectable });
