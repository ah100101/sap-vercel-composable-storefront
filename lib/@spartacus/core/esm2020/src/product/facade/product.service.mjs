...
ProductService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ProductService, deps: [{ token: i1.Store }, { token: i2.ProductLoadingService }], target: i0.ɵɵFactoryTarget.Injectable });
