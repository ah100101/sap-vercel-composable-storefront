...
CouponSearchPageResolver.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CouponSearchPageResolver, deps: [{ token: i1.ProductSearchService }, { token: i2.TranslationService }, { token: i3.AuthService }, { token: i4.ActivatedRoute }, { token: i5.SemanticPathService }], target: i0.ɵɵFactoryTarget.Injectable });
