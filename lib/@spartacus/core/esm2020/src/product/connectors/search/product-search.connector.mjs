...
ProductSearchConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ProductSearchConnector, deps: [{ token: i1.ProductSearchAdapter }], target: i0.ɵɵFactoryTarget.Injectable });
