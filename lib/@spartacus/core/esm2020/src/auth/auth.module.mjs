...
AuthModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: AuthModule, imports: [CommonModule, i1.UserAuthModule, i2.ClientAuthModule] });
