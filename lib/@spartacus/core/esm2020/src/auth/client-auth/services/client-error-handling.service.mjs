...
ClientErrorHandlingService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ClientErrorHandlingService, deps: [{ token: i1.ClientTokenService }], target: i0.ɵɵFactoryTarget.Injectable });
