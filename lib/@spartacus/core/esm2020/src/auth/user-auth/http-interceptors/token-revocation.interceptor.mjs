...
TokenRevocationInterceptor.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: TokenRevocationInterceptor, deps: [{ token: i1.AuthStorageService }, { token: i2.AuthConfigService }], target: i0.ɵɵFactoryTarget.Injectable });
