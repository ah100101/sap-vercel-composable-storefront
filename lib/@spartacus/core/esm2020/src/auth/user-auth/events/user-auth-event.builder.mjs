...
UserAuthEventBuilder.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserAuthEventBuilder, deps: [{ token: i1.StateEventService }, { token: i2.EventService }, { token: i3.AuthService }], target: i0.ɵɵFactoryTarget.Injectable });
