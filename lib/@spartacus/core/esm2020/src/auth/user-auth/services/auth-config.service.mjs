...
AuthConfigService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: AuthConfigService, deps: [{ token: i1.AuthConfig }, { token: i2.OccConfig }], target: i0.ɵɵFactoryTarget.Injectable });
