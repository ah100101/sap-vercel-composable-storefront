...
AuthRedirectService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: AuthRedirectService, deps: [{ token: i1.RoutingService }, { token: i2.Router }, { token: i3.AuthRedirectStorageService }, { token: i4.AuthFlowRoutesService }], target: i0.ɵɵFactoryTarget.Injectable });
