...
I18nConfigInitializer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: I18nConfigInitializer, deps: [{ token: i1.ConfigInitializerService }], target: i0.ɵɵFactoryTarget.Injectable });
