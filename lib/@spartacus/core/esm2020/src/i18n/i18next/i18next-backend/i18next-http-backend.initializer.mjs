...
I18nextHttpBackendInitializer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: I18nextHttpBackendInitializer, deps: [{ token: I18NEXT_INSTANCE }, { token: I18NEXT_HTTP_BACKEND_CLIENT }, { token: i1.I18nConfig }, { token: i2.WindowRef }], target: i0.ɵɵFactoryTarget.Injectable });
