...
CustomSerializer.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CustomSerializer, deps: [{ token: i1.RoutingConfigService }], target: i0.ɵɵFactoryTarget.Injectable });
