...
SemanticPathService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: SemanticPathService, deps: [{ token: i1.RoutingConfigService }, { token: i2.UrlParsingService }], target: i0.ɵɵFactoryTarget.Injectable });
