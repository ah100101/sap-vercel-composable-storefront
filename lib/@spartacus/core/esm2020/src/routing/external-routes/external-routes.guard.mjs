...
ExternalRoutesGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ExternalRoutesGuard, deps: [{ token: i1.WindowRef }, { token: PLATFORM_ID }], target: i0.ɵɵFactoryTarget.Injectable });
