...
CmsPageConnector.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CmsPageConnector, deps: [{ token: i1.CmsPageAdapter }, { token: i2.CmsStructureConfigService }], target: i0.ɵɵFactoryTarget.Injectable });
