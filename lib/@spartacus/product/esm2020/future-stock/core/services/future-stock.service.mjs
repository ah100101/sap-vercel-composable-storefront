...
FutureStockService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: FutureStockService, deps: [{ token: i1.UserIdService }, { token: i2.FutureStockConnector }, { token: i1.RoutingService }], target: i0.ɵɵFactoryTarget.Injectable });
