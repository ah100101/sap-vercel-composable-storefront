...
FutureStockModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: FutureStockModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
FutureStockModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: FutureStockModule, imports: [i1.FutureStockCoreModule, FutureStockOccModule,
        FutureStockComponentsModule] });
FutureStockModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: FutureStockModule, imports: [FutureStockCoreModule.forRoot(),
        FutureStockOccModule,
        FutureStockComponentsModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: FutureStockModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
