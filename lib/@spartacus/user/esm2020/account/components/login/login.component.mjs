...
LoginComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: LoginComponent, deps: [{ token: i1.AuthService }, { token: i2.UserAccountFacade }], target: i0.ɵɵFactoryTarget.Component });
