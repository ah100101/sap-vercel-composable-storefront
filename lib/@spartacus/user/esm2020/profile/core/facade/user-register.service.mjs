...
UserRegisterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserRegisterService, deps: [{ token: i1.UserProfileService }, { token: i2.UserProfileConnector }, { token: i3.AuthService }, { token: i3.CommandService }, { token: i4.Store }], target: i0.ɵɵFactoryTarget.Injectable });
