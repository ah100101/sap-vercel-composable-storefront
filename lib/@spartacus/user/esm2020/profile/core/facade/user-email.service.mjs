...
UserEmailService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserEmailService, deps: [{ token: i1.UserIdService }, { token: i2.UserProfileConnector }, { token: i1.CommandService }], target: i0.ɵɵFactoryTarget.Injectable });
