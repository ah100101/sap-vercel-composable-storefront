...
exports.CURRENCY_SERVICE_MIGRATION = [
    {
        ...
        comment: "// ".concat(constants_1.TODO_SPARTACUS, " Method '").concat(constants_1.CURRENCY_SERVICE, ".").concat(constants_1.INITIALIZE, "' was removed. The state initialization is done with the 'CurrencyInitializer' .")
    },
];
