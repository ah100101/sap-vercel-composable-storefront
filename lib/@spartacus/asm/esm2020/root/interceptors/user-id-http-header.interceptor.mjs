...
UserIdHttpHeaderInterceptor.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: UserIdHttpHeaderInterceptor, deps: [{ token: i1.Config }, { token: i1.UserIdService }, { token: OCC_USER_ID_CONSTANTS }], target: i0.ɵɵFactoryTarget.Injectable });
