...
AsmEnablerService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: AsmEnablerService, deps: [{ token: i1.Location }, { token: i2.WindowRef }, { token: i3.LaunchDialogService }, { token: i2.FeatureModulesService }], target: i0.ɵɵFactoryTarget.Injectable });
