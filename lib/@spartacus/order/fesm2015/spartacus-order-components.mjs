...
class OrderConfirmationShippingComponent {
    constructor(orderFacade, translationService, cd, outlet) {
        ...
        this.order$ = this.orderFacade
            ...
            .pipe(tap((order) => {
            var _a;
            this.entries = (_a = order === null || order === void 0 ? void 0 : order.entries) === null || _a === void 0 ? void 0 : _a.filter((entry) => entry.deliveryPointOfService === undefined);
        }));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: OrderConfirmationShippingComponent, decorators: [{
        ...
        return [{ type: i1.OrderFacade }, { type: i2.TranslationService }, { type: i0.ChangeDetectorRef }, { type: i3$1.OutletContextData, decorators: [{
                        type: Optional
                    }] }];
...
class OrderHistoryComponent {
    constructor(routing, orderHistoryFacade, translation, replenishmentOrderHistoryFacade) {
        ...
        this.orders$ = this.orderHistoryFacade
            ...
            this.hasPONumber =
                ((_c = (_b = orders === null || orders === void 0 ? void 0 : orders.orders) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.purchaseOrderNumber) !== undefined;
        }));
