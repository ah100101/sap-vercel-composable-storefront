...
OrderConfirmationGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: OrderConfirmationGuard, deps: [{ token: i1.OrderFacade }, { token: i2.Router }, { token: i3.SemanticPathService }], target: i0.ɵɵFactoryTarget.Injectable });
