...
CheckoutCostCenterService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterService, deps: [{ token: i1.ActiveCartFacade }, { token: i2.UserIdService }, { token: i2.CommandService }, { token: i3.CheckoutCostCenterConnector }, { token: i4.CheckoutQueryFacade }, { token: i2.EventService }], target: i0.ɵɵFactoryTarget.Injectable });
