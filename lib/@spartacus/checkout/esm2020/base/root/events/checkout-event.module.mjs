...
CheckoutEventModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutEventModule, deps: [{ token: i1.CheckoutQueryEventListener }, { token: i2.CheckoutDeliveryAddressEventListener }, { token: i3.CheckoutDeliveryModeEventListener }, { token: i4.CheckoutPaymentEventListener }, { token: i5.CheckoutPlaceOrderEventListener }, { token: i6.CheckoutLegacyStoreEventListener }], target: i0.ɵɵFactoryTarget.NgModule });
