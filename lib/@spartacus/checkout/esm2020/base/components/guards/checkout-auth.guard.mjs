...
CheckoutAuthGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutAuthGuard, deps: [{ token: i1.AuthService }, { token: i1.AuthRedirectService }, { token: i2.CheckoutConfigService }, { token: i3.ActiveCartFacade }, { token: i1.SemanticPathService }, { token: i4.Router }], target: i0.ɵɵFactoryTarget.Injectable });
