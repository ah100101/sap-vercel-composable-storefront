...
import { normalizeHttpError, backOff, isJaloError, OCC_HTTP_TOKEN, provideDefaultConfig } from '@spartacus/core';
...
class OccCheckoutPaymentTypeAdapter {
    ...
    getPaymentTypes() {
        ...
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error))), backOff({ shouldRetry: isJaloError }), map((paymentTypeList) => { var _a; return (_a = paymentTypeList.paymentTypes) !== null && _a !== void 0 ? _a : []; }), this.converter.pipeableMany(CHECKOUT_PAYMENT_TYPE_NORMALIZER));
    }
...
CheckoutB2BOccModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BOccModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CheckoutB2BOccModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BOccModule, imports: [CommonModule] });
CheckoutB2BOccModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BOccModule, providers: [
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BOccModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [CommonModule],
                    providers: [
