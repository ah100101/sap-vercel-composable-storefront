...
import { ADDRESS_SERIALIZER, normalizeHttpError, backOff, isJaloError, ADDRESS_NORMALIZER, PAYMENT_DETAILS_NORMALIZER, HttpParamsURIEncoder, provideDefaultConfig } from '@spartacus/core';
...
class OccCheckoutDeliveryModesAdapter {
    ...
    getSupportedModes(userId, cartId) {
        return this.http
            ...
            .pipe(catchError((error) => throwError(normalizeHttpError(error))), backOff({
            shouldRetry: isJaloError,
        }), pluck('deliveryModes'), map((modes) => modes !== null && modes !== void 0 ? modes : []), this.converter.pipeableMany(DELIVERY_MODE_NORMALIZER));
    }
