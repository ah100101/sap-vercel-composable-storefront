...
import { Component, ChangeDetectionStrategy, HostBinding, NgModule, ViewChild, Injectable, isDevMode } from '@angular/core';
...
import { I18nModule, ConfigModule, provideDefaultConfig, isNotUndefined, getLastValueSync, UrlModule, B2BUserRole, GlobalMessageType } from '@spartacus/core';
import { Subscription, combineLatest, of, BehaviorSubject } from 'rxjs';
import { filter, distinctUntilChanged, map, take, tap, switchMap } from 'rxjs/operators';
...
CheckoutCostCenterComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterComponent, deps: [{ token: i1.UserCostCenterService }, { token: i5.CheckoutCostCenterFacade }, { token: i5.CheckoutPaymentTypeFacade }], target: i0.ɵɵFactoryTarget.Component });
...
CheckoutCostCenterModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CheckoutCostCenterModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterModule, declarations: [CheckoutCostCenterComponent], imports: [CommonModule,
        I18nModule, i1.ConfigModule] });
CheckoutCostCenterModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterModule, imports: [CommonModule,
        I18nModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutCostCenterModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
B2BCheckoutDeliveryAddressComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: B2BCheckoutDeliveryAddressComponent, deps: [{ token: i1.UserAddressService }, { token: i1$1.CheckoutDeliveryAddressFacade }, { token: i3.ActivatedRoute }, { token: i1.TranslationService }, { token: i4.ActiveCartFacade }, { token: i2.CheckoutStepService }, { token: i1$1.CheckoutDeliveryModesFacade }, { token: i1.GlobalMessageService }, { token: i5.CheckoutCostCenterFacade }, { token: i5.CheckoutPaymentTypeFacade }, { token: i1.UserCostCenterService }], target: i0.ɵɵFactoryTarget.Component });
...
B2BCheckoutDeliveryAddressModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: B2BCheckoutDeliveryAddressModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
B2BCheckoutDeliveryAddressModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: B2BCheckoutDeliveryAddressModule, declarations: [B2BCheckoutDeliveryAddressComponent], imports: [CommonModule,
        RouterModule,
        AddressFormModule,
        CardModule,
        SpinnerModule,
        I18nModule], exports: [B2BCheckoutDeliveryAddressComponent] });
B2BCheckoutDeliveryAddressModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: B2BCheckoutDeliveryAddressModule, providers: [
        ...
        SpinnerModule,
        I18nModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: B2BCheckoutDeliveryAddressModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
CheckoutPaymentTypeComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeComponent, deps: [{ token: i5.CheckoutPaymentTypeFacade }, { token: i2.CheckoutStepService }, { token: i3.ActivatedRoute }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i5.CheckoutPaymentTypeFacade }, { type: i2.CheckoutStepService }, { type: i3.ActivatedRoute }]; }, propDecorators: { poNumberInputElement: [{
                type: ViewChild,
...
CheckoutPaymentTypeModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CheckoutPaymentTypeModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeModule, declarations: [CheckoutPaymentTypeComponent], imports: [CommonModule,
        I18nModule,
        SpinnerModule, i1.ConfigModule], exports: [CheckoutPaymentTypeComponent] });
CheckoutPaymentTypeModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeModule, imports: [CommonModule,
        I18nModule,
        SpinnerModule,
        ConfigModule.withConfig({
            cmsComponents: {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutPaymentTypeModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
...
CheckoutB2BAuthGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BAuthGuard, deps: [{ token: i1.AuthService }, { token: i1.AuthRedirectService }, { token: i2.CheckoutConfigService }, { token: i4.ActiveCartFacade }, { token: i1.SemanticPathService }, { token: i3.Router }, { token: i5$1.UserAccountFacade }, { token: i1.GlobalMessageService }], target: i0.ɵɵFactoryTarget.Injectable });
CheckoutB2BAuthGuard.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BAuthGuard, providedIn: 'root' });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BAuthGuard, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
CheckoutB2BStepsSetGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BStepsSetGuard, deps: [{ token: i2.CheckoutStepService }, { token: i1.RoutingConfigService }, { token: i1$1.CheckoutDeliveryAddressFacade }, { token: i1$1.CheckoutPaymentFacade }, { token: i1$1.CheckoutDeliveryModesFacade }, { token: i3.Router }, { token: i5.CheckoutPaymentTypeFacade }, { token: i5.CheckoutCostCenterFacade }, { token: i4.ActiveCartFacade }], target: i0.ɵɵFactoryTarget.Injectable });
...
CheckoutB2BComponentsModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CheckoutB2BComponentsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BComponentsModule, imports: [CommonModule,
        CheckoutCostCenterModule,
        CheckoutPaymentTypeModule,
        B2BCheckoutDeliveryAddressModule,
        B2BCheckoutReviewSubmitModule] });
CheckoutB2BComponentsModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BComponentsModule, providers: [
        {
        ...
        B2BCheckoutDeliveryAddressModule,
        B2BCheckoutReviewSubmitModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CheckoutB2BComponentsModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
