...
import { Injectable, InjectionToken, NgModule, isDevMode } from '@angular/core';
import * as i2 from '@spartacus/core';
import { StateUtils, PROCESS_FEATURE, SiteContextActions, normalizeHttpError, withdrawOn, GlobalMessageType, OCC_USER_ID_ANONYMOUS, EMAIL_PATTERN, OCC_CART_ID_CURRENT, isNotUndefined, AuthActions, BASE_SITE_CONTEXT_ID, StorageSyncType, MODULE_INITIALIZER, ConfigInitializerService, createFrom, getLastValueSync, OCC_USER_ID_GUEST, CommandStrategy, ProcessSelectors, HttpErrorHandler, HttpResponseStatus, StateModule } from '@spartacus/core';
...
import { map, concatMap, catchError, mergeMap, groupBy, switchMap, withLatestFrom, filter, distinctUntilKeyChanged, tap, take, switchMapTo, distinctUntilChanged, shareReplay, pairwise, debounce } from 'rxjs/operators';
        ...
        this.setActiveCartId$ = createEffect(() => this.actions$.pipe(ofType(LOAD_CART_SUCCESS, LOAD_CART, CREATE_CART_SUCCESS, CREATE_CART, SET_ACTIVE_CART_ID), map((action) => {
            ...
            switch (action.type) {
                ...
                case CREATE_CART_SUCCESS: {
                    return new SetCartTypeIndex({
                        cartType: ((_e = (_d = action === null || action === void 0 ? void 0 : action.payload) === null || _d === void 0 ? void 0 : _d.extraData) === null || _e === void 0 ? void 0 : _e.active)
                            ? CartType.ACTIVE
...
ActiveCartService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ActiveCartService, deps: [{ token: i1$2.MultiCartFacade }, { token: i2.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ActiveCartService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i1$2.MultiCartFacade }, { type: i2.UserIdService }]; } });
