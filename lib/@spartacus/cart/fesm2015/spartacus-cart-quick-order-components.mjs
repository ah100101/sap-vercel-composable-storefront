...
import { Component, ChangeDetectionStrategy, NgModule, isDevMode, Injectable, Input, ViewChild } from '@angular/core';
...
import { GlobalMessageType, I18nModule, provideDefaultConfig, UrlModule } from '@spartacus/core';
