...
QuickOrderFormComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: QuickOrderFormComponent, deps: [{ token: i1.Config }, { token: i0.ChangeDetectorRef }, { token: i2.QuickOrderFacade }, { token: i1.WindowRef }], target: i0.ɵɵFactoryTarget.Component });
