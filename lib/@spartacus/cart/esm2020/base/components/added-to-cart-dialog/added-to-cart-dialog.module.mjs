...
AddedToCartDialogModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: AddedToCartDialogModule, deps: [{ token: i1.AddedToCartDialogEventListener }], target: i0.ɵɵFactoryTarget.NgModule });
