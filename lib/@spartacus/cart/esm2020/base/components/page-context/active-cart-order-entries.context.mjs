...
ActiveCartOrderEntriesContext.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ActiveCartOrderEntriesContext, deps: [{ token: i1.ProductImportInfoService }, { token: i2.ActiveCartFacade }], target: i0.ɵɵFactoryTarget.Injectable });
