...
CartVoucherService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CartVoucherService, deps: [{ token: i1.Store }, { token: i2.ActiveCartFacade }, { token: i3.UserIdService }], target: i0.ɵɵFactoryTarget.Injectable });
