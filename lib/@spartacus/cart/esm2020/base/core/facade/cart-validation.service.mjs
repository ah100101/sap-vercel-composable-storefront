...
CartValidationService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CartValidationService, deps: [{ token: i1.CartValidationConnector }, { token: i2.CommandService }, { token: i2.UserIdService }, { token: i3.ActiveCartFacade }, { token: i4.CartValidationStateService }], target: i0.ɵɵFactoryTarget.Injectable });
