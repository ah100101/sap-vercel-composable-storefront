...
MultiCartStatePersistenceService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: MultiCartStatePersistenceService, deps: [{ token: i1.StatePersistenceService }, { token: i2.Store }, { token: i1.SiteContextParamsService }], target: i0.ɵɵFactoryTarget.Injectable });
