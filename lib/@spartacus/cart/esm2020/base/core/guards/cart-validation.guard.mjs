...
CartValidationGuard.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: CartValidationGuard, deps: [{ token: i1.CartValidationFacade }, { token: i2.SemanticPathService }, { token: i3.Router }, { token: i2.GlobalMessageService }, { token: i1.ActiveCartFacade }, { token: i4.CartValidationStateService }, { token: i5.CartConfigService }], target: i0.ɵɵFactoryTarget.Injectable });
