...
ExportOrderEntriesComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.4", ngImport: i0, type: ExportOrderEntriesComponent, deps: [{ token: i1.ExportOrderEntriesToCsvService }, { token: i2.ContextService }], target: i0.ɵɵFactoryTarget.Component });
